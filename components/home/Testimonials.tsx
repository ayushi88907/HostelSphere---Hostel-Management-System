...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    {
      quote:
        "As a warden managing over 500 students, I needed a solution that was both powerful and easy to use. hostelSphere delivered beyond expectations with its room booking and complaint management features.",
      author: "Michael Chen",
